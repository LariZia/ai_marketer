      ...
      <div className="rounded-2xl bg-white shadow-sm p-6">
        ...
        <form onSubmit={onSubmit} className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="block">
            <span className="block text-sm text-slate-600">Service name</span>
            <input name="service_name" placeholder="Ex: Premium lawn care" className="input mt-1 w-full" required />
          </label>
          <label className="block">
            <span className="block text-sm text-slate-600">Industry</span>
            <input name="industry" placeholder="Ex: Home services" className="input mt-1 w-full" />
          </label>
          <label className="block">
            <span className="block text-sm text-slate-600">Audience</span>
            <input name="audience" placeholder="Ex: Busy homeowners" className="input mt-1 w-full" />
          </label>
          <label className="block">
            <span className="block text-sm text-slate-600">Tone</span>
            <input name="tone" placeholder="Ex: Friendly and expert" className="input mt-1 w-full" />
          </label>
          <label className="block">
